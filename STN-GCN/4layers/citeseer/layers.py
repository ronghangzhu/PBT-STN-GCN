...
class GraphConvolutionBS_Hyper(Module):
    ...
    def __init__(self, in_features, out_features, num_hparams, activation=lambda x: x, bias=True):
        ...
        # Parameter setting.
        self.elem_weight = Parameter(torch.FloatTensor(in_features, out_features))
        self.hnet_weight = Parameter(torch.FloatTensor(out_features, in_features))
        # self.hnet_weight = Parameter(torch.FloatTensor(in_features, out_features))
        if self.bias:
            self.elem_bias = Parameter(torch.FloatTensor(out_features))
            self.hnet_bias = Parameter(torch.FloatTensor(out_features))
        else:
    ...
    def forward(self, input, adj, htensor):
        ...
        # print("hnet_scalars is ", hnet_scalars)
        # print("hnet_wscalars is ", hnet_wscalars)
        # print("hnet_bscalars is ", hnet_bscalars)
